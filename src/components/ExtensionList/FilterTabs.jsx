const FilterTabs = () => {
  return (
    <div className="flex flex-col text-center md:flex-row md:justify-between min-w-xs md:max-w-6xl mx-auto mb-7">
      <h1 className="text-xl md:text-3xl font-bold text-neutro-800 dark:text-neutro-100">Extensions List</h1>
